...
Sure, I can help you revise the content you provided to make it look more polished and organized for your GitHub repository. Here's an improved version:

### NVG-TK-GOOGLES: 3D Printed Night Vision Goggles for Airsoft Use

#### Introduction
Welcome to NVG-TK-GOOGLES, a cutting-edge project aimed at creating 3D printed night vision goggles optimized for airsoft enthusiasts. These goggles offer affordability, functionality, and impressive performance.

#### Science Behind the Project
To comprehend the concept of night vision technology, we need to understand the visible spectrum and infrared light. While the human eye can perceive wavelengths between 380 and 700 nanometers, common night vision goggles operate with infrared light, ranging from 780nm to 1mm, which is invisible to the naked eye. However, digital cameras can pick up infrared light, making them indispensable for this project.

#### Hardware Choices
We explored two solutions for our night vision goggles:

**Solution 1**
Based on the project found in [YouTube link](https://www.youtube.com/watch?v=MthrbR4_UAk&t=500s), this approach used FPV high-resolution night vision cameras in conjunction with TFT displays. While functional, this option lacked the core feature of infrared lighting and proved costly due to the price of FPV cameras.

**Solution 2**
After extensive research, we identified a camera with built-in infrared sensitivity and night vision capabilities, addressing the need for infrared lighting and simplifying the project. [Link to Camera](https://pt.aliexpress.com/item/1005005338137609.html?spm=a2g0o.productlist.main.15.7ae414631x433U&algo_pvid=4b931d3a-d59c-426e-8473-9e1e93f62575&aem_p4p_detail=202307241308272014997737209960001745738&algo_exp_id=4b931d3a-d59c-426e-8473-9e1e93f62575-7&pdp_npi=3%40dis%21BRL%21241.40%21156.91%21%21%21345.84%21%21%4021227bf916902293079494648d0bdf%2112000032662752561%21sea%21BR%213124747279&curPageLogUid=DhVBPfh4VJDW&search_p4p_id=202307241308272014997737209960001745738_8)

#### Hardware Studies
We thoroughly examined the chosen digital cameras to understand their specifications and compatibility:

- Camera 1:
  - IR Sensitivity: Yes
  - Resolution: 640x480 at 30FPS
  - Power Usage: 110mA-280mA
  - Supply: 5V
  - Lens Options: 68°, 80°, 90°, 100°, 120°, 150°, 170°
...
Camera 1 proved to be the ideal choice due to its panoramic functionality, low distortion lenses, and perfect PCB size for easy mounting. While Camera 2 offered a more budget-friendly option, it lacked the built-in IR LED and had a more challenging PCB format.

#### TFT Displays
To replace the costly Adafruit option, we found 2-inch TFT displays at a better price point. [Link to TFT Display](https://pt.aliexpress.com/item/1005004380216204.html?gatewayAdapt=glo2bra)

#### Installation and Usage
We provide detailed step-by-step instructions for assembling and using the night vision goggles, along with setup guidelines for hardware and software.

#### Acknowledgments and Credits
We extend our gratitude to everyone who contributed to the success of this project, and we credit the sources that inspired and guided us.

#### License and Contact Information
NVG-TK-GOOGLES is licensed under [License Type]. For any questions or feedback, feel free to contact us at [Your Email Address].
...
Note: Replace the placeholders in square brackets with actual details, such as the license type you choose, folder names, and your email address.

Remember to update the repository with additional progress and improvements as you continue working on the project. With this revised content, your GitHub repository will be well-structured and visually appealing to potential collaborators and users.
